...
export default function CartDrawer({ isOpen, onClose, items, onRemove, onUpdateQty, total, onCheckout }: CartDrawerProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      {/* Drawer */}
      <div className="relative w-full max-w-sm bg-card h-full flex flex-col shadow-2xl animate-slide-right">
        {/* Header */}
          ...
          {items.length === 0 ? (
            <div className="flex-1 flex flex-col items-center justify-center gap-4 py-16 text-center">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Add equipment to get started</p>
              </div>
            ...
            items.map(({ product, quantity }) => (
              <div key={product.id} className="flex gap-3 bg-background rounded-xl p-3 border border-border">
                <img
        ...
        {items.length > 0 && (
          <div className="p-4 border-t border-border bg-card flex flex-col gap-3">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-success font-medium text-sm">Calculated at checkout</span>
            </div>
